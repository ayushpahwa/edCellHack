          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="experience" value="<?php echo $this->input->post('experience'); ?>" class="form-control" id="experience" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="improvements" class="form-control" id="improvements"><?php echo $this->input->post('improvements'); ?></textarea>
						</div>
					</div>
					<div class="col-md-6">
						<label for="teacher_feedback" class="control-label">Teacher Feedback</label>
						<div class="form-group">
							<textarea name="teacher_feedback" class="form-control" id="teacher_feedback"><?php echo $this->input->post('teacher_feedback'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
