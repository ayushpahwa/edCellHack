          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="student_roll_no" value="<?php echo $this->input->post('student_roll_no'); ?>" class="form-control" id="student_roll_no" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="student_device_no" class="control-label">Student Device No</label>
						<div class="form-group">
							<input type="text" name="student_device_no" value="<?php echo $this->input->post('student_device_no'); ?>" class="form-control" id="student_device_no" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="student_email" class="control-label">Student Email</label>
						<div class="form-group">
							<input type="text" name="student_email" value="<?php echo $this->input->post('student_email'); ?>" class="form-control" id="student_email" />
						</div>
					</div>
					<div class="col-md-6">
